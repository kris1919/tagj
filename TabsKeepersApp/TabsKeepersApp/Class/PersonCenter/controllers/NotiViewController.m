...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    NormalNotiCell *cell = [tableView dequeueReusableCellWithIdentifier:@"NormalNotiCell" forIndexPath:indexPath];
...
-(TKTableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"NormalNotiCell" bundle:nil] forCellReuseIdentifier:@"NormalNotiCell"];
