...
@property (nonatomic, strong) DHThreadSafeMultableArray<NSString*>* parentid; ///<父节点 parentId
@property (nonatomic, copy) NSString* basicParentid;  ///<basic parentId
@property (nonatomic, assign) MBL_UNIT_TYPE chnlUnitType;///<单元类型 unit type
@property (nonatomic, assign) MBL_FACE_TYPE faceFunctionType;///<单元类型 unit type
...
@property (nonatomic, strong) DSSEncChannelInfo* encChannelInfo;  ///< 编码器信息 encoding channelinfo
@property (nonatomic, strong) DSSAlarmInChannelInfo* alarminChannelInfo;  ///< 报警输入信息 alarmin channelinfo
@property (nonatomic, strong) DSSDoorControlChannelInfo* doorCtrlChannelInfo;  ///< 门禁信息  doorCtrl channelInfo
@property (nonatomic, strong) DSSDecChannelInfo* decChannelInfo;  ///< 解码器信息 decoding channelInfo
@property (nonatomic, strong) DSSTVWallInChannelInfo *tvWallInChannelInfo;
@property (nonatomic, strong) DSSTVWallOutChannelInfo *tvWallOutChannelInfo;
@end
